        ...
        <div class="hero-content">
            ...
            <form id="loginForm" method="post">
             ...
             <div class="footer-text">
                    <p>Don't have an account? <a href="signup.jsp" class="text-primary">Sign up here</a>.</p>
                </div>
                <div class="footer-text">
                    <p>For Admin login <a href="adminlogin.jsp" class="text-primary">click here.</a>.</p>
                </div>
    ...
    document.getElementById('loginForm').addEventListener('submit', function(event) {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                window.location.href ='quiz_list.jsp';
            } else {
